...
{	
	...
	LCD_ShowString(0,50,200,16,16,year_mon_dat);
	//刷新小时，分钟，秒
	sprintf(hour_min_sec,"%.2d:%.2d:%.2d",calendar.hour,calendar.min,calendar.sec);
	LCD_ShowString(91,50,200,16,16,hour_min_sec);
	switch(calendar.week)
		{
			case 0:
				LCD_ShowString(165,50,200,16,16,"Sunday    ");
				break;
			case 1:
				LCD_ShowString(165,50,200,16,16,"Monday    ");
				break;
			case 2:
			...
			case 4:
				...
				break;
			case 5:
				LCD_ShowString(165,50,200,16,16,"Friday    ");
				break;
			case 6:
				LCD_ShowString(165,50,200,16,16,"Saturday  ");
				break;  
		}
}
...
/* 函数名：RTC_Set_Uart
 * 描述  ：通过串口设置时间
 * 输入  ：argc参数个数；**argv命令行参数字符串指针数值指针
 * 返回  : 无
 * 调用  ：Finsh调用              
*/
...
MSH_CMD_EXPORT(RTC_Set_Uart,exmaple: RTC_Set_Uart <2019 09 08 09 56 23>)
