...
void SPI1_Init (void)	
{
    ...
    SPI1_Handler.Init.CLKPolarity=SPI_POLARITY_HIGH;    //串行同步时钟的空闲状态为低电平
    ...
    SPI1_Handler.Init.BaudRatePrescaler=SPI_BAUDRATEPRESCALER_256;//定义波特率预分频的值:波特率预分频值为64
...
{
	uint8_t Rxdata;
    HAL_SPI_TransmitReceive(&SPI1_Handler,&byte,&Rxdata,1, 1000);       
