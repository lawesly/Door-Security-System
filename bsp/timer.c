...
{  
    ...
    HAL_TIM_PWM_Stop(&TIM3_Handler,TIM_CHANNEL_2);//开启PWM通道2 	   
}
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    ...
    {
        GREEN_LED =!GREEN_LED;        //GREEN_LED反转
    }
}


//通过串口设置PWM占空比
uint8_t SET_PWM(int argc,char **argv)
{
	TIM_SetTIM3Compare2(atoi(argv[1]));
	return 1;
}
MSH_CMD_EXPORT(SET_PWM,exmaple: SET_PWM <2019 >);
