...
#define y1_mode 43
#define y2_mode 92
#define x1_register 3
#define x2_register 118
#define y1_register 275
#define y2_register 314
#define x1_delete 126
#define x2_delete 234
#define y1_delete 275
#define y2_delete 314
#define x1_psw    3
#define x2_psw    233
#define y1_psw    53
#define y2_psw    268
...
//注册和删除按键触控位置
#define Register           (((tp_dev.x[0]>x1_register)&&(tp_dev.x[0]<x2_register))&&((tp_dev.y[0]>y1_register)&&(tp_dev.y[0]<y2_register)))
#define Delete             (((tp_dev.x[0]>x1_delete)&&(tp_dev.x[0]<x2_delete))&&((tp_dev.y[0]>y1_delete)&&(tp_dev.y[0]<y2_delete)))
#define Set_Psw            (((tp_dev.x[0]>x1_psw)&&(tp_dev.x[0]<x2_psw))&&((tp_dev.y[0]>y1_psw)&&(tp_dev.y[0]<y2_psw)))
#define Y                  (((tp_dev.x[0]>x1_register)&&(tp_dev.x[0]<x2_register))&&((tp_dev.y[0]>y1_register)&&(tp_dev.y[0]<y2_register)))
#define N                  (((tp_dev.x[0]>x1_delete)&&(tp_dev.x[0]<x2_delete))&&((tp_dev.y[0]>y1_delete)&&(tp_dev.y[0]<y2_delete)))
#define Back           	   (((tp_dev.x[0]>x1_register)&&(tp_dev.x[0]<x2_register))&&((tp_dev.y[0]>y1_register)&&(tp_dev.y[0]<y2_register)))
#define New                (((tp_dev.x[0]>x1_delete)&&(tp_dev.x[0]<x2_delete))&&((tp_dev.y[0]>y1_delete)&&(tp_dev.y[0]<y2_delete)))
#define Show_RD            {LCD_ShowString(15,282,200,24,24,"Register   Delete ");LCD_DrawLine(120, 272, 120, 320);}
#define Show_BDN           {LCD_ShowString(15,282,200,24,24," Back     Del/New ");LCD_DrawLine(120, 272, 120, 320);}
#define Show_BN            {LCD_ShowString(15,282,200,24,24," Back        New  ");LCD_DrawLine(120, 272, 120, 320);}
...
//数字键盘触控位置--密码设定
#define One                 (((tp_dev.x[0]>0)&&(tp_dev.x[0]<77))&&((tp_dev.y[0]>162)&&(tp_dev.y[0]<199)))
#define Two                 (((tp_dev.x[0]>78)&&(tp_dev.x[0]<166))&&((tp_dev.y[0]>162)&&(tp_dev.y[0]<199)))
#define Three               (((tp_dev.x[0]>167)&&(tp_dev.x[0]<239))&&((tp_dev.y[0]>162)&&(tp_dev.y[0]<199)))
#define Four                (((tp_dev.x[0]>0)&&(tp_dev.x[0]<77))&&((tp_dev.y[0]>201)&&(tp_dev.y[0]<236)))
#define Five                (((tp_dev.x[0]>78)&&(tp_dev.x[0]<166))&&((tp_dev.y[0]>201)&&(tp_dev.y[0]<236)))
#define Six                 (((tp_dev.x[0]>167)&&(tp_dev.x[0]<239))&&((tp_dev.y[0]>201)&&(tp_dev.y[0]<236)))
#define Seven               (((tp_dev.x[0]>0)&&(tp_dev.x[0]<77))&&((tp_dev.y[0]>238)&&(tp_dev.y[0]<279)))
#define Eight               (((tp_dev.x[0]>78)&&(tp_dev.x[0]<166))&&((tp_dev.y[0]>238)&&(tp_dev.y[0]<279)))
#define Nine                (((tp_dev.x[0]>167)&&(tp_dev.x[0]<239))&&((tp_dev.y[0]>238)&&(tp_dev.y[0]<279)))
#define DB                  (((tp_dev.x[0]>0)&&(tp_dev.x[0]<77))&&((tp_dev.y[0]>282)&&(tp_dev.y[0]<320)))
#define Zero                (((tp_dev.x[0]>78)&&(tp_dev.x[0]<166))&&((tp_dev.y[0]>282)&&(tp_dev.y[0]<320)))
#define OK                  (((tp_dev.x[0]>167)&&(tp_dev.x[0]<239))&&((tp_dev.y[0]>282)&&(tp_dev.y[0]<320)))
//函数声明
...
void security_door_window(void);
void register_delete_GUI(uint8_t mode);
//LCD分辨率设置
